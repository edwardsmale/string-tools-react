      ...
      <table cellPadding={3} cellSpacing={0}>
        ...
        <tbody>
          <tr>
            ...
            <td className="context-popup-content__value">{this.props.firstLineContext.isArrayOfArrays ? "True" : "False"}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="context-popup-content__value">
              <table cellPadding={1} cellSpacing={0}>
                <tbody>
                  {this.props.firstLineContext.columnInfo.headers?.map((header, index) => (<tr key={`${Math.random()}`}><td className="context-popup-content__Header">{header}</td></tr>))}
                </tbody>
              </table>
